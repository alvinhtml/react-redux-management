		...
		if(count > limit){
            ...
            return (
                <div className="pagelist">
                    ...
                    转到 <input onKeyPress={this.inputEnterEvent} type="text" {n=>this.gotoPage=n} defaultValue={page} /> 页
	...
	render() {
		...
		return (
            <div className="olist-tool olist-search">
                <input type="text" className="form-control" ref={n=>this.search=n} placeholder={searchMode} defaultValue={} onKeyPress={this.inputEnterEvent} />
 ...
 * @type {String}
 */
export class Listconf extends Component {
